...
export function usage() {
  ...
  run-standing-browser-parity.mjs --mode candidate-diagnostic --output-dir DIR --live-completion-policy POLICY.json --candidate-identity IDENTITY.json --live-reference-ledger REFERENCE.json --live-reference-sha256 SHA256 [--browser-root DIR] [--browser-executable PATH] [--viewport WIDTHxHEIGHT] [--timeout-ms N] [--settle-ms N]
