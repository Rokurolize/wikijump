...
export const OPEN43_SETTINGS_BROWSER_SOURCE_BLIND_CASE_IDS = Object.freeze([
  "B610_CHROME_INITIAL",
  "B610_CHROME_SETTLED",
  "B610_FAVICON_ARTICLE_SIDEBAR_THEME_NETWORK",
  "B610_EXACT_SERVED_IDENTITIES",
...
export function verifyOpen43SettingsBrowserCase(caseId, rawObservations, rawPlan) {
  ...
  if (OPEN43_SETTINGS_BROWSER_SOURCE_BLIND_CASE_IDS.includes(caseId)) {
    if (observations.candidate_configuration?.mode !== "source_blind") throw new Error(`${caseId} source-blind configuration is missing`);
    return { verified: true, configuration_only: true };
  }
