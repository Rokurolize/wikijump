...
const entry = (caseIds, load, aliasOf, executionClass = "exclusive") => Object.freeze({
...
const readOnlyEntry = (caseIds, load) => entry(caseIds, load, undefined, "read_only");

export const CANDIDATE_CASE_SETS = Object.freeze({
  "ftml-marker-contract": readOnlyEntry(["F1380_FTML_MARKER_CONTRACT"], () => import("./ftml-marker-contract-candidate-case-set.mjs").then(({ createFtmlMarkerContractCandidateCaseSet }) => createFtmlMarkerContractCandidateCaseSet())),
  ...
  "open43-categories": entry(["Q1028_CATEGORY_LIFECYCLE_AND_CACHE", "Q1028_EXPAND_LIST_ACTION"], () => import("./open43-categories-candidate-case-set.mjs").then(({ createOpen43CategoriesCandidateCaseSet }) => createOpen43CategoriesCandidateCaseSet())),
  "open43-media-files": entry(["M756_LOCAL_ROUTE_BYTES", "M1039_MUTATION_TO_NEXT_READ", "M1043_RESIZED_BLOB_IDENTITY", "M1062_SERIALIZABLE_ACTION_RESPONSE", "M1062_UPLOAD_TRANSACTION_ORDER"], () => import("./open43-media-candidate-case-set.mjs").then(({ createOpen43MediaCandidateCaseSet }) => createOpen43MediaCandidateCaseSet())),
  ...
  "open43-b610-shell": readOnlyEntry(["B610_SHELL_PUBLIC_CONTRACT"], () => import("./open43-b610-shell-candidate-case-set.mjs").then(({ createOpen43B610ShellCandidateCaseSet }) => createOpen43B610ShellCandidateCaseSet())),
  ...
  "open43-searchall": readOnlyEntry(["Q807_EXACT_CANDIDATE_FORM_ROUTE_BROWSER"], () => import("./open43-q807-searchall-candidate-case-set.mjs").then(({ createOpen43Q807SearchAllCandidateCaseSet }) => createOpen43Q807SearchAllCandidateCaseSet())),
  ...
  "open43-a1038-admin-boundary": readOnlyEntry(["A1038_AUTHENTICATED_NON_ADMIN_DENIAL"], () => import("./open43-a1038-admin-boundary-candidate-case-set.mjs").then(({ createOpen43A1038AdminBoundaryCandidateCaseSet }) => createOpen43A1038AdminBoundaryCandidateCaseSet())),
  ...
  "open43-a1037-forms": entry(["A1037_NEWPAGE_EXACT_CANDIDATE", "A1037_REDIRECT_EXACT_CANDIDATE"], () => import("./open43-a1037-forms-candidate-case-set.mjs").then(({ createOpen43A1037FormsCandidateCaseSet }) => createOpen43A1037FormsCandidateCaseSet())),
  "open43-q778-forum-mini": readOnlyEntry(["Q778_EXACT_CANDIDATE_24_CASE_REPLAY", "Q778_EXACT_CANDIDATE_SAVED_PAGE_RUNTIME", "Q778_BROWSER_ROUTE_IDENTITY_AND_SETTLING"], () => import("./open43-q778-forum-mini-candidate-case-set.mjs").then(({ createOpen43Q778ForumMiniCandidateCaseSet }) => createOpen43Q778ForumMiniCandidateCaseSet())),
  "open43-q1034-forum": readOnlyEntry(["Q1034_EXACT_CANDIDATE_PUBLIC_READ_MODELS", "Q1034_EXACT_CANDIDATE_FORUM_ROUTES_AND_AJAX", "Q1034_EXACT_CANDIDATE_RECENTTHREADS"], () => import("./open43-q1034-forum-candidate-case-set.mjs").then(({ createOpen43Q1034ForumCandidateCaseSet }) => createOpen43Q1034ForumCandidateCaseSet())),
  "open43-q1035-sitechanges": readOnlyEntry(["Q1035_SITECHANGES_DEFAULT_INITIAL_SNAPSHOT", "Q1035_SITECHANGES_PERMISSION_BEFORE_LIMIT", "Q1035_SITECHANGES_FILTER_AND_AJAX_PAGER", "Q1035_LISTDRAFTS_EMPTY_STATE_MATRIX"], () => import("./open43-q1035-sitechanges-candidate-case-set.mjs").then(({ createOpen43Q1035SiteChangesCandidateCaseSet }) => createOpen43Q1035SiteChangesCandidateCaseSet())),
  ...
  "open43-q1026-user-identity": entry(["Q1026_EXACT_CANDIDATE_PREVIEW_SAVED_IDENTITY", "Q1026_BROWSER_PRINTUSER_INTERVALS", "Q1026_ACTOR_SPECIAL_IDENTITY_MATRIX"], () => import("./open43-q1026-user-identity-candidate-case-set.mjs").then(({ createOpen43Q1026UserIdentityCandidateCaseSet }) => createOpen43Q1026UserIdentityCandidateCaseSet())),
  ...
  "open43-q1032-members-userinfo": readOnlyEntry(["Q1032_EXACT_CANDIDATE_DIRECTORY_MATRIX", "Q1032_MEMBERS_AJAX_EXACT_CANDIDATE", "Q1032_BROWSER_DIRECTORY_ACTIONS"], () => import("./open43-q1032-members-userinfo-candidate-case-set.mjs").then(({ createOpen43Q1032CandidateCaseSet }) => createOpen43Q1032CandidateCaseSet())),
  "open43-q1036-search-feed": readOnlyEntry(["Q1036_EXACT_CANDIDATE_PREVIEW_SAVED_BOUNDARIES"], () => import("./open43-q1036-search-feed-candidate-case-set.mjs").then(({ createOpen43Q1036CandidateCaseSet }) => createOpen43Q1036CandidateCaseSet())),
  ...
  "open43-featuredsite": readOnlyEntry(["Q810_CANDIDATE_FAIL_CLOSED_NETWORK"], () => import("./open43-q810-featuredsite-candidate-case-set.mjs").then(({ createOpen43FeaturedSiteCandidateCaseSet }) => createOpen43FeaturedSiteCandidateCaseSet())),
  "open43-689-tabview": readOnlyEntry(["B689_TABVIEW_INITIAL", "B689_TABVIEW_SETTLED", "B689_SCP8980_AND_NAVIGATION_LIFECYCLE"], () => import("./open43-browser-689-candidate-case-set.mjs").then(({ createOpen43B689TabviewCandidateCaseSet }) => createOpen43B689TabviewCandidateCaseSet())),
  "open43-690-geometry": readOnlyEntry(["B690_GEOMETRY_INITIAL", "B690_GEOMETRY_SETTLED", "B690_FIXED_SIX_PAGE_DENOMINATOR"], () => import("./open43-browser-690-candidate-case-set.mjs").then(({ createOpen43B690GeometryCandidateCaseSet }) => createOpen43B690GeometryCandidateCaseSet())),
});
