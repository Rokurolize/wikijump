...
export async function candidateCaseSet(name) {
  ...
  if (name === "open43-settings-analytics" || name === "open43-settings-theme" || name === "open43-settings-toolbar") {
    const { createOpen43SettingsGroupCandidateCaseSet } = await import("./open43-settings-browser-candidate-case-set.mjs");
    return createOpen43SettingsGroupCandidateCaseSet({ group: name === "open43-settings-analytics" ? "analytics" : name === "open43-settings-theme" ? "theme" : "toolbar" });
  }
