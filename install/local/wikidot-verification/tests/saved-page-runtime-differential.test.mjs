...
function documentWithGenerator(html, generator = "ftml v1.42.0 [22222222]; deepwell-render/v11") {
...
test("compiled generator check rejects stale, missing, and duplicate page artifacts", () => {
  assert.equal(
    compiledGeneratorCheck(
      '{"compiled_generator":"ftml v1.42.0 [22222222]; deepwell-render/v11"}',
      identity.ftml_sha,
    ).status,
    "match",
  );
  ...
  assert.equal(
    compiledGeneratorCheck(
      '{compiled_generator:"ftml v1.42.0 [11111111]; deepwell-render/v11"}',
      identity.ftml_sha,
    ).status,
    "mismatch",
  );
