...
test("#754 and #755 candidate group denominator keeps unavailable rows blocked", () => {
  ...
  assert.match(candidateCaseUsage(), /open43-settings-analytics\|open43-settings-theme/u);
});
