...
test("ListPages cannot terminate when a P8 observation is still unobserved", () => {
  const ledger = structuredClone(canonicalLedger);
  ledger.features["module-listpages"].status = "implemented";
  ledger.features[
    "module-listpages"
  ...
  ledger.feature_property_matrix["module-listpages"].P8 = {
    status: "unobserved",
    evidence: [
      "artifact:install/local/wikidot-verification/artifacts/listpages-runtime-budget-envelope.json",
    ],
    observation_gaps: ["Live temporal failure behavior has not been observed."],
  };
