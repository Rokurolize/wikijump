...
- EN source identity: `35234ec38792ffc739258798c50bb91d993575fb23eb6b6a51c58c2d02b26efd`; updated `2026-04-10T05:10:37+00:00`.
- JP baseline: Previous public JP source SHA-256 da06a9e340ca0f6faa0f900117f1c165eaffed070d2269df0a99aec038b06338 (updated 2026-03-17T14:48:29+00:00); EN was refreshed to 2026-04-10T05:10:37+00:00.
- Final candidate source/CSS SHA-256: `fe37b43f2e625648bd3575797d72ac72a3d2da75b55c866fe6eef6ca62a24676` / `34c4522a1d05e807bb0673f9dc3bdefa772757e2aee53b6b130bda6e5fa2cdf0`.
...
- Japanese font specimen: requested `"Open Sans", sans-serif`; actual platform font(s): IPAPGothic (29 Japanese glyphs).
...
- visual-rmse-localized-showcase-difference at desktop: RMSE 0.326323; This full-page RMSE compares different localized theme-showcase text/images and EN versus JP-native header/sidebar/account/rating runtime surfaces, so it is retained as a non-gating diagnostic and not mislabeled as a visual pass. The paired viewport screenshots were reviewed for theme identity, logo/palette, major composition, and responsive structure.
- visual-rmse-localized-showcase-difference at laptop: RMSE 0.383654; This full-page RMSE compares different localized theme-showcase text/images and EN versus JP-native header/sidebar/account/rating runtime surfaces, so it is retained as a non-gating diagnostic and not mislabeled as a visual pass. The paired viewport screenshots were reviewed for theme identity, logo/palette, major composition, and responsive structure.
- visual-rmse-localized-showcase-difference at tablet: RMSE 0.430651; This full-page RMSE compares different localized theme-showcase text/images and EN versus JP-native header/sidebar/account/rating runtime surfaces, so it is retained as a non-gating diagnostic and not mislabeled as a visual pass. The paired viewport screenshots were reviewed for theme identity, logo/palette, major composition, and responsive structure.
- visual-rmse-localized-showcase-difference at mobile: RMSE 0.363073; This full-page RMSE compares different localized theme-showcase text/images and EN versus JP-native header/sidebar/account/rating runtime surfaces, so it is retained as a non-gating diagnostic and not mislabeled as a visual pass. The paired viewport screenshots were reviewed for theme identity, logo/palette, major composition, and responsive structure.
