...
- FTML backlog decision: This PR accepts narrowly bounded Wikijump-side debt
  ...
  only for a fully consumed default-layout text/select subset; unknown syntax
  retains the ordinary page renderer and editor. An FTML backlog item should
  add a structured delayed data-form definition and Wikidot-layout table
  primitive before this subset is widened.
...
- Owner: Rokurolize
- Review trigger: Any widening beyond the observed text/select subset, any
