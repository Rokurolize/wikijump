# Embedding media syntax

- Feature ID: `syntax-embedding`
...
Parse and render Wikidot's documented embedding media syntax, including every documented form, option, output rule, and limitation.
...
- Recognize documented [[embedvideo]] and [[embedaudio]] block forms and the documented provider/embed forms. A live embedvideo block containing an iframe preserved its src, width, and height; the tested arbitrary embedaudio embed did not match and rendered 'Sorry, no match for the embedded content.'.

### P2 - parser stage, nesting, and composition

- The closing tag owns the embedded block body. Deprecated [[embed]] is a separate legacy matcher path and MUST NOT be treated as arbitrary trusted HTML.

### P3 - lifecycle, persistence, import, and round trips

- Embedding syntax is render-only and does not persist remote provider state. Saved page source remains the authored block.

### P4 - actors, permissions, visibility, and privacy

- Embedded remote resources execute only within the platform's HTML/CSP/security boundary. Authored embed content MUST NOT gain server-side credential or local-file authority.

### P5 - selection, ordering, counting, and pagination

- Embedding has no selection, counting, ordering, or pagination semantics.

### P6 - HTTP, API, URL, Ajax, feed, and navigation contracts

- Provider/resource URLs in successful embed output are browser-facing. Unsupported provider/body combinations MUST use the live unsupported-content error rather than a fabricated iframe.

### P7 - DOM, CSS, resources, interaction, and geometry

- The successful live embedvideo iframe is emitted inside a paragraph with the observed iframe attributes. Error cases use div.error-block. Provider-specific DOM is normative only where documented or live-observed.

### P8 - temporal behavior, failure atomicity, limits, and resource bounds

- Remote load success/failure is not equivalent to parser success. The renderer must decide the supported embed shape deterministically before browser network completion and must not expose unsafe fallback HTML.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc-wiki-syntax:embedding/source.wikidot.txt:1` through line 39 (canonical)
...
### doc-wiki-syntax:embedding (canonical)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc-wiki-syntax:embedding/source.wikidot.txt:1` through line 39  
SHA-256 of complete source file: `4ae0d8ecb4fbddbda7b59c2cf97c9737c89697e4d6832c12d809be27cac9c232`

```wikidot
L0001 ++ [[# video]]Video
L0002 
L0003 To embed video directly into the page use {{@@[[embedvideo]] ... [[/embedvideo]]@@}} block.
L0004 Between the the "embedding html code" should be placed from any of the following video online galleries:
L0005 
L0006 * [http://video.google.com Google Video]
L0007 * [http://www.youtube.com YouTube]
L0008 
L0009 E.g.
L0010 
L0011 [[code]]
L0012 [[embedvideo]]
L0013 <embed style="width:400px; height:326px;" id="VideoPlayback" align="middle"
L0014 type="application/x-shockwave-flash"
L0015 src="http://video.google.com/googleplayer.swf?docId=263244138622602613"
L0016 allowScriptAccess="sameDomain" quality="best" bgcolor="#ffffff" scale="noScale" salign="TL"
L0017 FlashVars="playerMode=embedded"> </embed>
L0018 [[/embedvideo]]
L0019 [[/code]]
L0020 
L0021 ++ [[# audio]]Audio
L0022 
L0023 To embed audio use {{@@[[embedaudio]] ... [[/embedaudio]]@@}} and the html embedding code found on the audio hosting website.
L0024 
L0025 Currently supported are:
L0026 * [http://www.odeo.com Odeo.com]
L0027 
L0028 E.g.
L0029 [[code]]
L0030 [[embedaudio]]
L0031 <embed src="http://www.odeo.com/flash/audio_player_standard_gray.swf"
L0032 quality="high" width="300" height="52" name="audio_player_standard_gray"
L0033 align="middle" allowScriptAccess="always" wmode="transparent"
L0034 type="application/x-shockwave-flash" flashvars="audio_id=99133&audio_duration=282.0&valid_sample_rate=true&external_url=http://www.vitalpodcasts.com/FileSystem/podcasts/89/opensource_episode1.mp3" pluginspage="http://www.macromedia.com/go/getflashplayer" />
L0035 </embed><br /><a style="font-size: 9px; padding-left: 110px; color: #f39;
L0036 letter-spacing: -1px; text-decoration: none" href="http://odeo.com/audio/99133/view">
L0037 powered by <strong>ODEO</strong></a>
L0038 [[/embedaudio]]
L0039 [[/code]]
```
