# Ad Module Above Content Module

- Feature ID: `module-admoduleabovecontent`
- Category: `module`
...
Recognize and implement the `AdModuleAboveContent` module at the documented invocation sites. The corpus does not provide a dedicated module reference page.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc:layout-reference/source.wikidot.txt:62` through line 62 (invocation-only)

## Documentation-derived behavioral evidence

### doc:layout-reference (invocation-only)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc:layout-reference/source.wikidot.txt:62` through line 62  
