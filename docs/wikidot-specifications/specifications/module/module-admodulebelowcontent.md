# Ad Module Below Content Module

- Feature ID: `module-admodulebelowcontent`
- Category: `module`
...
Recognize and implement the `AdModuleBelowContent` module at the documented invocation sites. The corpus does not provide a dedicated module reference page.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc:layout-reference/source.wikidot.txt:63` through line 63 (invocation-only)

## Documentation-derived behavioral evidence

### doc:layout-reference (invocation-only)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc:layout-reference/source.wikidot.txt:63` through line 63  
