# Ad Module Below Footer Module

- Feature ID: `module-admodulebelowfooter`
- Category: `module`
...
Recognize and implement the `AdModuleBelowFooter` module at the documented invocation sites. The corpus does not provide a dedicated module reference page.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc:layout-reference/source.wikidot.txt:66` through line 66 (invocation-only)

## Documentation-derived behavioral evidence

### doc:layout-reference (invocation-only)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc:layout-reference/source.wikidot.txt:66` through line 66  
