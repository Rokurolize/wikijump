...
Recognize and implement the `UserInfo` module at the documented invocation sites. The corpus does not provide a dedicated module reference page.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/user:info/source.wikidot.txt:1` through line 1 (invocation-only)

## Documentation-derived behavioral evidence

### user:info (invocation-only)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/user:info/source.wikidot.txt:1` through line 1  
SHA-256 of complete source file: `231a264e2d178dae60f4faab3dd72ac3bd926785d1b8ec063a4fead072c7a9d6`

```wikidot
L0001 [[module UserInfo]]
```
