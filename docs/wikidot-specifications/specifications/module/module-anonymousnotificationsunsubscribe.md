# Anonymous Notifications Unsubscribe Module

- Feature ID: `module-anonymousnotificationsunsubscribe`
- Category: `module`
...
Recognize and implement the `AnonymousNotificationsUnsubscribe` module at the documented invocation sites. The corpus does not provide a dedicated module reference page.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/un/source.wikidot.txt:1` through line 1 (invocation-only)

## Documentation-derived behavioral evidence

### un (invocation-only)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/un/source.wikidot.txt:1` through line 1  
SHA-256 of complete source file: `54d5e20df248f477dd93b10f52600563354f61772fd7ca194a6dd30fb3d5765f`

```wikidot
L0001 [[module AnonymousNotificationsUnsubscribe]]
```
