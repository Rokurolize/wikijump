...
CI runs no compatibility tests. Offline units, fixtures, retained-artifact checks, replay behavior, live acquisition, candidate parity, and `live-reference` production run in local WSL using persistent identity-bound caches.
