...
#[derive(Debug, Clone)]
pub(super) struct WikidotUserDisplay {
    pub(super) user_id: i64,
    pub(super) name: String,
    pub(super) slug: Option<String>,
    pub(super) wikidot_profile: bool,
}

#[derive(Debug, Clone)]
pub(super) struct ListPagesSnapshotDisplay {
    pub(super) created_at: time::OffsetDateTime,
    pub(super) updated_at: time::OffsetDateTime,
    pub(super) created_by_name: Option<String>,
    pub(super) updated_by_name: Option<String>,
    pub(super) comments: i32,
    pub(super) commented_at: Option<time::OffsetDateTime>,
    pub(super) commented_by_name: Option<String>,
    pub(super) rating_votes: Option<i64>,
    pub(super) parent_fullname: Option<String>,
    pub(super) source_revision_count: i32,
}
