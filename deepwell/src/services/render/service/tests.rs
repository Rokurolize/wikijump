...
//!
//! `super` here resolves to `service`, exactly as it did while this was an
//! inline `mod tests`, so every path below reaches the parent module's private
//! items unchanged.
...
fn parses_corpus_list_pages_date_selector_alias() {
    ...
    let aliased = parse_list_pages_arguments(r#" category="_default" date="2017.05" "#)
...
fn flags_wikidot_list_pages_selectors_that_cannot_be_honored() {
    ...
    let honored = parse_list_pages_arguments(r#" category="_default" tags="+fixture" "#)
