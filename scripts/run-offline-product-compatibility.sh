...
# runner above. Six shards are the measured stable optimum on the maintained
# WSL host; callers can still override 1..8 for another machine.
WIKIJUMP_DEEPWELL_TEST_SHARDS="${WIKIJUMP_DEEPWELL_TEST_SHARDS:-6}" \
  "${GUARD}" node \
